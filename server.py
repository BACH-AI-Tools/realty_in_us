...
if API_KEY:
    ...
    default_headers["X-RapidAPI-Host"] = "realty-in-us.p.rapidapi.com"
else:
...
async def _add_rapidapi_headers(method, url, **kwargs):
    ...
    if API_KEY:
        ...
        kwargs['headers']['X-RapidAPI-Host'] = "realty-in-us.p.rapidapi.com"
    else:
...
def main():
    """主入口点"""
    print(f"🚀 启动 Realty In Us MCP 服务器")
    print(f"📦 版本: {__tag__}")
