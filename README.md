...
这是一个使用 [FastMCP](https://fastmcp.wiki) 自动生成的 MCP 服务器，用于访问 Realty In Us API。

- **PyPI 包名**: `bach-realty_in_us`
- **版本**: 1.0.0
- **传输协议**: stdio
...
**注意**: 请将 `E:\path\to\realty_in_us\server.py` 替换为实际的服务器文件路径。
